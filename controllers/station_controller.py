...
class StationController:
    def __init__(self):
        ...
        self.charging_stations = {
            "Posto 1": {"x": 18.0, "y": 32.0, "ocupado": False, "tempo_expiracao": None,"id": None, "queue" : []},
            "Posto 2": {"x": 500.0, "y": 708.0, "ocupado": False, "tempo_expiracao": None,"id": None, "queue" : []},
            "Posto 3": {"x": 1280.0, "y": 2202.0, "ocupado": False, "tempo_expiracao": None,"id": None, "queue" : []},
            "Posto 4": {"x": 4000.0, "y": 2190.0, "ocupado": False, "tempo_expiracao": None,"id": None, "queue" : []},
            "Posto 5": {"x": 1200.0, "y": 3120.0, "ocupado": False, "tempo_expiracao": None,"id": None, "queue" : []},
        }
    ...
    def get_station_mais_proximo(self, x, y,id):
        ...
        for nome, dados_posto in self.charging_stations.items():
            tempo = len(dados_posto["queue"]) * 80 + calcular_distancia(x, y, dados_posto["x"], dados_posto["y"])
            if tempo < menorTempo:
                menorTempo = tempo
